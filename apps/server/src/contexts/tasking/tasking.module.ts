...
import { FileTasksProvider, GithubIssuesProvider, JiraProvider } from './infrastructure/providers';
import { TypeormTaskRepository, TypeormTaskSourceRepository } from './infrastructure/typeorm-repositories';
...
@Module({
  ...
  providers: [
    ...
    { provide: TASK_SOURCE_REPOSITORY, useClass: TypeormTaskSourceRepository },
    {
      ...
      useFactory: (github: GithubIssuesProvider, file: FileTasksProvider, jira: JiraProvider) => [github, file, jira],
    },
  ],
